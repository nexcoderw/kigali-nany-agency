...
MIDDLEWARE = [
    ...
    'django.middleware.locale.LocaleMiddleware',  # Added for i18n support
...
WSGI_APPLICATION = 'kna.wsgi.application'
...
DEFAULT_FROM_EMAIL = os.getenv('DEFAULT_FROM_EMAIL', 'Your App <dynasoftserver1@gmail.com>')
